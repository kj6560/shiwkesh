...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <!-- <img src="<?php echo e(asset('theme')); ?>/img/logo.png" alt=""> -->
        <h1 class="sitename"><?php echo e(env('Company_Name')); ?></h1>
        <span>.</span>
      </a>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename"><?php echo e($settings['Company_Name']??""); ?></span>
            </a>
            <div class="footer-contact pt-3">
              <p><?php echo e($settings['Company_Address']??""); ?></p>
              <p class="mt-3"><strong>Phone:</strong> <span><?php echo e($settings['Company_Mobile']??""); ?></span></p>
              <p><strong>Email:</strong> <span><?php echo e($settings['Company_Email']??""); ?></span></p>
            </div>
          </div>
    ...
    <div class="copyright text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div>
            © Copyright <strong><span><?php echo e(env('Company_Full_Name')); ?></span></strong> All Rights Reserved
          </div>
  ...
  <script src="<?php echo e(asset('theme')); ?>/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
...
</html><?php /**PATH C:\MyFiles\workspace\php\shiwkesh\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>