...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><?php echo e(!empty($tag) && $tag->id ? "Edit" : "Create"); ?> Blog Tag
                        <?php echo e(!empty($tag->name) ? " : " . $tag->name : ""); ?>

                    </h4>
                    <?php echo $__env->make('backend.errors.formErrors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <form method="POST" action="/blogSettings/tags/store" enctype="multipart/form-data"
                        class="forms-sample">

                        <?php if(!empty($tag->id)): ?>
                            <input type="text" name="id" value="<?php echo e(!empty($tag) && $tag->id ? $tag->id : null); ?>"
                        ...
                        <div class="col" style="margin: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="name"
                                    value="<?php echo e(!empty($tag) && $tag->name ? $tag->name : old('name')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <select name="active" class="form-select" id="exampleSelectGender">
                                    ...
                                    <option value="1" <?php if( isset($tag) && $tag->active == 1): ?> selected
                                    <?php endif; ?>>Yes
                                    </option>
                                    <option value="0" <?php if(isset($tag) && $tag->active == 0): ?> selected
                                    <?php endif; ?>>No
                                    </option>
                                </select>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFiles\workspace\php\shiwkesh\resources\views\backend\blog\createTag.blade.php ENDPATH**/ ?>