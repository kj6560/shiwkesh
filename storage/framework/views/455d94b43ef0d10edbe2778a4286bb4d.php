            ...
            <div class="col-lg-4">
                ...
                <div class="info">
                    ...
                    <div class="info-item d-flex">
                        ...
                        <div>
                            <h4>Email:</h4>
                            <p><?php echo e($settings['Company_Email']??""); ?></p>
                        </div>
                    </div><!-- End Info Item -->
                    ...
                    <div class="info-item d-flex">
                        ...
                        <div>
                            <h4>Call:</h4>
                            <p><?php echo e($settings['Company_Mobile']??""); ?></p>
                        </div>
                    </div><!-- End Info Item -->
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFiles\workspace\php\shiwkesh\resources\views\frontend\contact_us.blade.php ENDPATH**/ ?>