...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><?php echo e(!empty($post) && $post->id ? "Edit" : "Create"); ?> Post
                    ...
                    <form method="POST" action="/blogSettings/blogs/store" enctype="multipart/form-data"
                        ...
                        <?php if(!empty($post->id)): ?>
                            <input type="text" name="id" value="<?php echo e(!empty($post) && $post->id ? $post->id : null); ?>"
                        ...
                        <div class="col" style="margin: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="title"
                                    value="<?php echo e(!empty($post) && $post->title ? $post->title : old('title')); ?>"
                                    class="form-control" id="exampleInputUsername1">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername1">Post Small Description</label>
                                <textarea class="exp_text" name="small_desc" rows="5"
                                    id="content"><?php echo e(!empty($post) && $post->small_desc ? $post->small_desc : old('small_desc')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername1">Post Content</label>
                                <textarea class="exp_text" name="content" rows="20"
                                    id="content"><?php echo e(!empty($post) && $post->content ? $post->content : old('content')); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-select" id="exampleSelectGender">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php if(isset($post) && $post->category_id == $category->id): ?> selected <?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select name="show_on_homepage" class="form-select" id="exampleSelectGender">
                                    ...
                                    <option value="1" <?php if(isset($post) && $post->show_on_homepage == 1): ?> selected <?php endif; ?>>Yes
                                    </option>
                                    <option value="0" <?php if(isset($post) && $post->show_on_homepage == 0): ?> selected <?php endif; ?>>No
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="show_large_on_homepage" class="form-select" id="exampleSelectGender">
                                    ...
                                    <option value="1" <?php if(isset($post) && $post->show_large_on_homepage == 1): ?> selected <?php endif; ?>>Yes
                                    </option>
                                    <option value="0" <?php if(isset($post) && $post->show_large_on_homepage == 0): ?> selected <?php endif; ?>>No
                                    </option>
                                </select>
                            ...
                            <select style="height: 200px;" name="tags[]" class="form-select" id="exampleSelectTags" multiple>
                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tag->id); ?>" <?php if(isset($selectedTags) && in_array($tag->id, $selectedTags)): ?> selected <?php endif; ?>>
                                        <?php echo e($tag->name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="active" class="form-select" id="exampleSelectGender">
                                    ...
                                    <option value="1" <?php if(isset($post) && $post->active == 1): ?> selected <?php endif; ?>>Yes
                                    </option>
                                    <option value="0" <?php if(isset($post) && $post->active == 0): ?> selected <?php endif; ?>>No
                                    </option>
                                </select>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFiles\workspace\php\shiwkesh\resources\views\backend\blog\createBlog.blade.php ENDPATH**/ ?>