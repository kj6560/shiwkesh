...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{!empty($tag) && $tag->id ? "Edit" : "Create"}} Blog Tag
                    ...
                    <form method="POST" action="/blogSettings/tags/store" enctype="multipart/form-data"
                        ...
                        @if (!empty($tag->id))
                            <input type="text" name="id" value="{{!empty($tag) && $tag->id ? $tag->id : null}}"
                        ...
                        <div class="col" style="margin: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="name"
                                    value="{{!empty($tag) && $tag->name ? $tag->name : old('name')}}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="active" class="form-select" id="exampleSelectGender">
                                    ...
                                    <option value="1" @if( isset($tag) && $tag->active == 1) selected
                                    @endif>Yes
                                    </option>
                                    <option value="0" @if(isset($tag) && $tag->active == 0) selected
                                    @endif>No
                                    </option>
                                </select>
